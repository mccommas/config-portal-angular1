(function () {
    "use strict";
    configAppControllers.controller('AddSuppQuestionModal', ["$scope", "toastr", "$timeout", "$uibModalInstance", "$location", "Restangular", "formQuestData",
        function ($scope, toastr, $timeout, $uibModalInstance, $location, Restangular, formQuestData) {
            ...
            $scope.cancel = function () {
                ...
                toastr.warning('Question Changes Canceled', 'Canceled', {
                    allowHtml: true
                });
            };
            ...
            //    }
            //};
// above code was causing the essay option to not validate. Changed it to below code and works now
            ...
            if (formQuestData.action !== "delete") {
                ...
                $scope.saveQuestion = function (addQuestionModal) {
                    ...
                    if (local_environment) {
                        ...
                        $scope.save_quest_url = "gateway/saveOrUpdateGatewayQuestion/" + formQuestData.questionSetId;
                        $scope.post_quest_server($scope.save_quest_url);

                    }
                    toastr.success('Question Changes Saved', 'Success', {
                        allowHtml: true
                    });
                ...
                $scope.removeQuestion = function () {
                    if (local_environment) {
                        ...
                        $scope.delete_quest_url = "gateway/deleteGatewayQuestion/" + formQuestData.question.id;
                ...
                $scope.cancelDelete = function () {
                    ...
                    toastr.success('Delete Canceled', 'Canceled', {
                        allowHtml: true
                    });
                };
